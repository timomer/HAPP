...
public class ExtendedGraphBuilder extends BgGraphBuilder  {
    ...
    public Line miniobcobShowLine() {
        List<PointValue> minShowValues = new ArrayList<PointValue>();
        minShowValues.add(new PointValue((float) start_time, (float) 0));
        minShowValues.add(new PointValue((float) end_time, (float) 0));
